...
export default function ATSResumePage() {
  ...
  const autoDownload = state?.autoDownload || false;
                ...
                experience.length
                  ? experience
                    ...
                    <div class="item">
                      ...
                      ${
                        (job.tags || []).length
                          ? `<div class="chips" style="margin-top:10px;">${job.tags.map((tag) => `<span class="chip">${tag}</span>`).join("")}</div>`
                          : ""
                      }
                    </div>
                  `
  ...
  return (
    <div className="ats-page">
      <div className="ats-box">
        <h2>ATS Resume Page</h2>
        <p>Your ATS resume is ready.</p>
